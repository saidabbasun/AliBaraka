...
export default function BlogStories() {
    const ListStory=[
        ...
        {id:1, Title:'Beginner', Text:'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius.' ,Subtitle:'More Information'},
        {id:1, Title:'Professional', Text:'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius.' ,Subtitle:'More Information'}
    ]
  return (
