...
export default function BlogStories() {
  ...
  <Card.Body>
    <Card.Title className='mb-5 CardStoryTitle'>"I learned so much, even as a professional".</Card.Title>
    ...
    <Card.Subtitle className="mb-2 CardSubtitle">Juan Huang</Card.Subtitle>
  </Card.Body>
</Card>
        </div>
