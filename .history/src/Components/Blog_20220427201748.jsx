...
export default function Blog() {
  ...
  <Accordion.Item eventKey="0">
    <Accordion.Header className='AHeader'>Do you provide customer support?</Accordion.Header>
  ...
  <Accordion.Item eventKey="1">
    <Accordion.Header className='AHeader'>How much traffic can the hosting handle?</Accordion.Header>
    <Accordion.Body>
      Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
