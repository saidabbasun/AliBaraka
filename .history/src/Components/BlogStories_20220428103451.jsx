...
export default function BlogStories() {
  ...
  <Card.Body>
    <Card.Title className='mb-5 CardTitle'>"I learned so much, even as a professional".</Card.Title>
    ...
    <Card.Subtitle className="mb-2 text-muted text-danger">Juan Huang</Card.Subtitle>
  </Card.Body>
</Card>
        </div>
