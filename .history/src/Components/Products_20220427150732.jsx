...
export default function Praducts() {
  const ListCard=[
    ...
    {id:1, CardImg:Product3, CardTitle:'Asosiy Plyonka Turlari', CardText:'Et magni et ea unde tempore. Corrupti quia adipisci qui dicta sint.'},
    {id:1, CardImg:Product4, CardTitle:'Asosiy Plyonka Turlari', CardText:'Et magni et ea unde tempore. Corrupti quia adipisci qui dicta sint.'},
    {id:1, CardImg:Product5, CardTitle:'Asosiy Plyonka Turlari', CardText:'Et magni et ea unde tempore. Corrupti quia adipisci qui dicta sint.'},
    {id:1, CardImg:Product6, CardTitle:'Asosiy Plyonka Turlari', CardText:'Et magni et ea unde tempore. Corrupti quia adipisci qui dicta sint.'},
  ]
  return (
